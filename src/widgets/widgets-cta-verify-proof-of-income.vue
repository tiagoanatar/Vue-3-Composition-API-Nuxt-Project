...
const { data, pending } = getCtaData('widget-ctas-proof-of-income');
import { DocType } from '@/constants/docType';
import { IconNames } from '@/constants/icons';
const { cancelUploadDocument, getDocuments, uploadDocument } =
  useUploadDocuments(DocType.PROOF_OF_INCOME);
...
// TODO: The CMS should send these labels.
const LABELS = {
